...
#### Installation
- in CMD: "python -m venv venv" (--python="/usr/bin/python2.6")
	- activate it: ".\venv\Scripts\activate"
- in CMD (venv): pip install -r requirements.txt --> can take a few minutes
- pip install requests Pillow numpy opencv-python pygame
...
![Demo on Youtube](https://www.youtube.com/watch?v=A0NcyUApxUw)
